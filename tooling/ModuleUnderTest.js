...
import moduleFromBundle    from '../dist/feature-redux-logic';
import moduleFromBundleMin from '../dist/feature-redux-logic.min';
...
switch (MODULE_PLATFORM) {
  ...
  case undefined:
    ...
    break;
  case 'bundle':  
    console.log(`*** Testing Module Platform found in: dist/feature-redux-logic (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
    moduleUnderTest = moduleFromBundle;
    break;
  case 'bundle.min':  
    console.log(`*** Testing Module Platform found in: dist/feature-redux-logic.min (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
...
const { logicAspect } = moduleUnderTest;
